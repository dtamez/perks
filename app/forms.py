...
class WholeLifePlanForm(AdminPlanForm):
    def __init__(self, *args, **kwargs):
        kwargs.update({'prefix': 'whole_life_plan'})
        super(WholeLifePlanForm, self).__init__(*args, **kwargs)
...
class SpouseWholeLifePlanForm(AdminPlanForm):
    def __init__(self, *args, **kwargs):
        kwargs.update({'prefix': 'spouse_whole_life_plan'})
        super(SpouseWholeLifePlanForm, self).__init__(*args, **kwargs)
...
class ChildWholeLifePlanForm(AdminPlanForm):
    def __init__(self, *args, **kwargs):
        kwargs.update({'prefix': 'child_whole_life_plan'})
        super(ChildWholeLifePlanForm, self).__init__(*args, **kwargs)
