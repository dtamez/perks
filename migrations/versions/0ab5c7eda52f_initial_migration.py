...
Revision ID: 0ab5c7eda52f
Revises:
Create Date: 2017-04-14 22:04:45.219196
...
def upgrade():
    #  commands auto generated by Alembic - please adjust! ###
        ...
        op.create_table('carrier',
                        ...
                        sa.Column('phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(length=20),
                                  nullable=True),
        ...
        op.create_table('plan',
                        ...
                        sa.Column('cust_service_phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(length=20),
                                  nullable=True),
                        sa.Column('website', sqlalchemy_utils.types.url.URLType(), nullable=True),
                        sa.Column('not_available_in', sqlalchemy_utils.types.scalar_list.ScalarListType(),
                                  nullable=True),
        ...
        op.create_table('dental_plan',
                        ...
                        sa.Column('plan_termination_timing_type_id', sqlalchemy_utils.types.choice.ChoiceType(
                            models.PLAN_TERMINATION_TIMING_TYPES), nullable=True),
        ...
        op.create_table('employee',
                        ...
                        sa.Column('gender', sqlalchemy_utils.types.choice.ChoiceType(models.GENDER_TYPES),
                                  nullable=True),
                        sa.Column('marital_status', sqlalchemy_utils.types.choice.ChoiceType(models.MARITAL_STATUSES),
                                  nullable=True),
                        sa.Column('smoker_type', sqlalchemy_utils.types.choice.ChoiceType(models.SMOKER_TYPES),
                                  nullable=True),
                        ...
                        sa.Column('salary_mode', sqlalchemy_utils.types.choice.ChoiceType(models.SALARY_MODE_TYPES),
                                  nullable=True),
                        sa.Column('salary_effective_date', sa.Date(), nullable=False),
                        sa.Column('salary', sa.Numeric(precision=9, scale=2), nullable=False),
                        sa.Column('phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(length=20),
                                  nullable=True),
                        sa.Column('alternate_phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(length=20),
                                  nullable=True),
                        sa.Column('emergency_contact_phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(
        ...
        op.create_table('plan_tier_premium',
                        sa.Column('id', sa.Integer(), nullable=False),
                        sa.Column('plan_id', sa.Integer(), nullable=True),
                        sa.Column('tier_type', sqlalchemy_utils.types.choice.ChoiceType(models.TIER_TYPES),
                                  nullable=True),
                        sa.Column('premium', sa.Numeric(precision=6, scale=2), nullable=False),
        ...
        op.create_table('std_plan',
                        ...
                        sa.Column('maximum_benefit', sa.Numeric(precision=10, scale=2), nullable=False),
                        sa.Column('id', sa.Integer(), nullable=False),
                        sa.Column('payout_interval', sqlalchemy_utils.types.choice.ChoiceType(
                            models.PAYOUT_INTERVAL_TYPES), nullable=True),
                        ...
                        sa.Column('mandatory_in_states', sqlalchemy_utils.types.scalar_list.ScalarListType(),
                                  nullable=True),
                        sa.ForeignKeyConstraint(['id'], ['plan.id'], ),
                        sa.PrimaryKeyConstraint('id')
                        )
        ...
        op.create_table('beneficiary',
                        ...
                        sa.Column('smoker_type', sqlalchemy_utils.types.choice.ChoiceType(models.SMOKER_TYPES),
                                  nullable=True),
                        sa.Column('beneficiary_type', sqlalchemy_utils.types.choice.ChoiceType(
                            models.BENEFICIARY_TYPES), nullable=True),
        ...
        op.create_table('dependent',
                        ...
                        sa.Column('smoker_type', sqlalchemy_utils.types.choice.ChoiceType(models.SMOKER_TYPES),
                                  nullable=True),
                        sa.Column('dependent_type', sqlalchemy_utils.types.choice.ChoiceType(models.DEPENDENT_TYPES),
                                  nullable=True),
        ...
        op.create_table('enrollment',
                        sa.Column('id', sa.Integer(), nullable=False),
                        sa.Column('employee_id', sa.Integer(), nullable=True),
                        sa.Column('life_event', sqlalchemy_utils.types.choice.ChoiceType(models.LIFE_EVENT_TYPES),
                                  nullable=True),
                        sa.ForeignKeyConstraint(['employee_id'], ['employee.id'], ),
                        sa.PrimaryKeyConstraint('id')
                        )
