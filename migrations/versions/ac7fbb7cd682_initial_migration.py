...
def upgrade():
    ...
    op.create_table(
        'irs_limits',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('min_fsa_medical_contribution', sa.Numeric(precision=9, scale=2), nullable=True),
    ...
    op.create_table(
        'plan',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('er_flat_amount_contributed', sa.Numeric(precision=9, scale=2), nullable=True),
        sa.Column('er_percentage_contributed', sa.Numeric(precision=3, scale=2), nullable=True),
        sa.Column('er_max_contribution', sa.Numeric(precision=9, scale=2), nullable=True),
    ...
    op.create_index(op.f('ix_age_banded_tier_plan_id'), 'age_banded_tier', ['plan_id'], unique=False)
    op.create_table(
        'age_based_reduction',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('plan_id', sa.Integer(), nullable=True),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_age_banded_tier_plan_id'), table_name='age_banded_tier')
    op.drop_table('age_banded_tier')
