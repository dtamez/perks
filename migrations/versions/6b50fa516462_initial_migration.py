...
def upgrade():
    ...
    sa.Column('state', sqlalchemy_utils.types.choice.ChoiceType(models.STATES), nullable=False),
    ...
    op.create_table('plan_premium',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('premium', sa.Numeric(precision=6, scale=2), server_default='0', nullable=False),
    sa.Column('employer_portion', sa.Numeric(precision=6, scale=2), server_default='0', nullable=False),
    sa.Column('employee_portion', sa.Numeric(precision=6, scale=2), server_default='0', nullable=False),
    sa.Column('premiumtype', sa.String(length=50), nullable=True),
    sa.Column('flat_amount', sa.Numeric(precision=6, scale=2), server_default='0', nullable=True),
    sa.Column('percentage', sa.Numeric(precision=3, scale=2), server_default='0', nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['id'], ['plan_premium.id'], ),
    sa.ForeignKeyConstraint(['plan_id'], ['plan.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_age_banded_premium_plan_id'), 'age_banded_premium', ['plan_id'], unique=False)
    ...
    op.create_table('dental_vision_bundle_plan',
    sa.Column('group_number', sa.Unicode(length=24), nullable=False),
    sa.Column('original_effective_date', sa.Date(), nullable=True),
    sa.Column('renewal_date', sa.Date(), nullable=True),
    sa.Column('existing', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('minimum_contribution', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('maximum_contribution', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['plan.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('medical_dental_bundle_plan',
    sa.Column('group_number', sa.Unicode(length=24), nullable=False),
    sa.Column('original_effective_date', sa.Date(), nullable=True),
    sa.Column('renewal_date', sa.Date(), nullable=True),
    sa.Column('existing', sa.Boolean(), nullable=False),
    ...
    op.create_table('medical_dental_vision_bundle_plan',
    sa.Column('group_number', sa.Unicode(length=24), nullable=False),
    sa.Column('original_effective_date', sa.Date(), nullable=True),
    sa.Column('renewal_date', sa.Date(), nullable=True),
    sa.Column('existing', sa.Boolean(), nullable=False),
    ...
    op.create_table('medical_vision_bundle_plan',
    sa.Column('group_number', sa.Unicode(length=24), nullable=False),
    sa.Column('original_effective_date', sa.Date(), nullable=True),
    sa.Column('renewal_date', sa.Date(), nullable=True),
    sa.Column('existing', sa.Boolean(), nullable=False),
    ...
    op.create_index(op.f('ix_plan_tier_premium_plan_id'), 'plan_tier_premium', ['plan_id'], unique=False)
    ...
    op.create_table('supplemental_insurance_plan',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['plan.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('plan_id', sa.Integer(), nullable=True),
    sa.Column('electiontype', sa.String(length=50), nullable=True),
    ...
    op.create_table('age_banded_price_election',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['election.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('self_price_election',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('amount', sa.Numeric(precision=11, scale=2), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['election.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('tiered_price_election',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('tiered_price_election')
    op.drop_table('self_price_election')
    op.drop_table('age_banded_price_election')
    ...
    op.drop_table('supplemental_insurance_plan')
    op.drop_table('std_plan')
    op.drop_index(op.f('ix_plan_tier_premium_plan_id'), table_name='plan_tier_premium')
    ...
    op.drop_index(op.f('ix_age_banded_premium_plan_id'), table_name='age_banded_premium')
    op.drop_table('age_banded_premium')
    op.drop_index(op.f('ix_user_username'), table_name='user')
    op.drop_index(op.f('ix_user_email'), table_name='user')
    op.drop_table('user')
    op.drop_table('role')
    op.drop_table('plan_premium')
