...
Revision ID: 7cab846b56be
Revises:
Create Date: 2017-03-21 13:41:41.124235
...
def upgrade():
    ...
    op.create_table('employee',
                    ...
                    sa.Column('alternate_phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(length=20),
                              nullable=True),
                    sa.Column('emergency_contact_phone', sqlalchemy_utils.types.phone_number.PhoneNumberType(length=20),
                              nullable=True),
    ...
    op.create_table('std_plan',
                    ...
                    sa.Column('maximum_benefit', sa.Numeric(precision=10, scale=2), nullable=False),
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('payout_interval', sqlalchemy_utils.types.choice.ChoiceType(models.PAYOUT_INTERVAL_TYPES),
                              nullable=True),
    ...
    op.create_table('beneficiary',
                    ...
                    sa.Column('smoker_type', sqlalchemy_utils.types.choice.ChoiceType(models.SMOKER_TYPES),
                              nullable=True),
                    sa.Column('beneficiary_type', sqlalchemy_utils.types.choice.ChoiceType(models.BENEFICIARY_TYPES),
                              nullable=True),
